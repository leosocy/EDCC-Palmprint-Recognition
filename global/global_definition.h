...
#define LIST_TEST_NUM_PER 2
#define LIST_TRAIN_NUM_TOTAL 6000
#define LIST_TEST_NUM_TOTAL 2000
#define WAVELET_LEVEL 5
#define WAVELET_BLOCK_SIZE 2
#define WAVELET_MATCH_METHOD "AC"  // ED = Euclidean distance   AC = "Angle cosine"

#define PREDICT_TRAIN_NUMBER_OF_PEOPLE 400
#define PREDICT_TRAIN_PER_PEOPLE_NUMBER_OF_IMAGE 10
#define ALL_PER_PEOPLE_NUMBER_OF_IMAGE 20
